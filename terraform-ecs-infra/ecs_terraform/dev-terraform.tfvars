...
public_subnets_cidr  = ["10.101.1.0/24", "10.101.2.0/24"]
private_subnets_cidr = ["10.101.3.0/24", "10.101.4.0/24"]
...
volume_size = "25"
key_name = "Dev-BastionAccessInstanceKey"
pre_assign_privateip = "10.101.1.100"
private_key_path = "./private-key/Dev-BastionAccessInstanceKey.pem"
## Security Group
remote_sg = {
  "22" = ["10.101.0.0/16","0.0.0.0/0"]
}
nginx_sg_ecs = {
  "80" = ["10.101.1.100/32"],
  "8000" = ["10.101.1.100/32"]
}
backend_alb_sg = {
  "80"   = ["0.0.0.0/0"],
  "443"   = ["0.0.0.0/0"],
